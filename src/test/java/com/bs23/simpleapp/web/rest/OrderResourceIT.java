...
import static com.bs23.simpleapp.web.rest.TestUtil.sameNumber;
...
class OrderResourceIT {
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().totalAmount(DEFAULT_TOTAL_AMOUNT).orderDate(DEFAULT_ORDER_DATE).deliveryAddress(DEFAULT_DELIVERY_ADDRESS);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().totalAmount(UPDATED_TOTAL_AMOUNT).orderDate(UPDATED_ORDER_DATE).deliveryAddress(UPDATED_DELIVERY_ADDRESS);
        return order;
    }
    ...
    void putExistingOrder() throws Exception {
        ...
        updatedOrder.totalAmount(UPDATED_TOTAL_AMOUNT).orderDate(UPDATED_ORDER_DATE).deliveryAddress(UPDATED_DELIVERY_ADDRESS);
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.orderDate(UPDATED_ORDER_DATE).deliveryAddress(UPDATED_DELIVERY_ADDRESS);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.totalAmount(UPDATED_TOTAL_AMOUNT).orderDate(UPDATED_ORDER_DATE).deliveryAddress(UPDATED_DELIVERY_ADDRESS);
